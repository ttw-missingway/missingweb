...
<div class="container flex flex-col">
	...
	<div class="grid grid-cols-3 gap-[1rem]">
		...
		<div
			class="p-[1rem] col-span-1 flex flex-col items-center justify-center border border-1 dark:border-white border-black border-opacity-20 dark:border-opacity-30"
		>
			<Alert.Root>
